...
*/
#include "protoSD.h"
protoSD::protoSD(int card_pin){
    pin=card_pin;
}
int protoSD::vector_size(){
    return vector.vector_size();
}
float protoSD::empty_float(){
    return vector.empty_float();
}
String protoSD::empty_string(){
    return vector.empty_string();
}
char protoSD::emtpy_char(){
    return vector.emtpy_char();
}
int protoSD::empty_int(){
...
bool protoSD::find(const char* path){
    return SD.exists(path);
}
void protoSD::create_directory(String path){
...
void protoSD::listfiles(String path){
...
void protoSD::remove_file(String path, String filename){
...
void protoSD::clearfile(String path, String filename){
    String directory=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    directory.toLowerCase();
    const char* directory_path=directory.c_str();
    if(!find(directory_path)){
...
void protoSD::write_string(String path, String filename, String content){
...
String protoSD::dump_string(String path, String filename, int index){
    String directory=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    directory.toLowerCase();
    const char* directory_path=directory.c_str();
    while(true){
...
void protoSD::write_float(String path, String filename, float input){
    String filepath=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    filepath.toLowerCase();
    const char* write_path=filepath.c_str();
...
float protoSD::dump_float(String path, String filename, int index){
    String directory=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    directory.toLowerCase();
...
void protoSD::write_char(String path, String filename, char input){
  String filepath=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
  filepath.toLowerCase();
  const char* write_path=filepath.c_str();
  if(path!=""){
...
char protoSD::dump_char(String path, String filename, int index){
    String directory=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    directory.toLowerCase();
    const char* read_path=directory.c_str();
    while(true){
...
void protoSD::write_int(String path, String filename, int input){
  String filepath=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
  filepath.toLowerCase();
  const char* write_path=filepath.c_str();
  if(path!=""){
...
int protoSD::dump_int(String path, String filename, int index){
    String directory=(path=="")? "/"+filename+".txt" : "/"+path+"/"+filename+".txt";
    directory.toLowerCase();
    const char* read_path=directory.c_str();
    while(true){
